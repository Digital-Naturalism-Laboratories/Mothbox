...
IMAGE_SCALE = 0.6  # Scale images to 60% of their original size
...
while running:
    ...
    # Draw current images with opacity based on chroma intensity
    for i in range(12):
        ...
        # Center the image at the random position
        pos = current_positions[i]
        rect = alpha_image.get_rect(center=pos)
