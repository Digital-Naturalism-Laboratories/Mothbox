...
unscrew very easily and consist of just a simple circuit board connected with thermal glue to the metal case.

![Untitled](https://github.com/Digital-Naturalism-Laboratories/Mothbox/assets/742627/4a2a69cb-d2a5-42db-90ee-46c9ac06e351)
You can take these apart, and using thermal silicone double sided tape (and maybe a little extra glue or screws), connect these UV LEDs to a piece of metal mounted inside the Mothbox, like with the method described above, for an Internal Mothbeam.
...
You need
* 12 V UV Lights [inexpensive 10W waterproof flood lights](https://www.amazon.com/gp/product/B01LT53312/ref=ppx_yo_dt_b_search_asin_title?ie=UTF8&psc=1) 
...
Twist the black wires together as well. Then stick them inside the connectors and keep twisting until they feel connected tightly.
...
### Seal it up even more if you are concerned about humidity and moisture.
{: .no_toc .text-delta }
...
You can even fill it full of hot glue if you are worried about water (like if you live in the rainforest!). But honestly, the twist nuts full of the silicone goo are probably good enough.
