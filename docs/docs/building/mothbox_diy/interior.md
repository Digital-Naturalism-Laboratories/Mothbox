...
{: .note }
> There is a small arrow with a dot at the top of each camera glare blocker circle. All the arrows and dots should be lined up on top of each other.
...
{: .note }
> The Camera Glare Blocker needs to be lined up correctly with the main board. You can use the small arrow to line it up with the mainboard. The arrow also points to the Mothbox Logo.
...
# Ringlights
These two circular lights function to evenly illuminate the target area to get high quality images of the moths. We use these ring lights, which are originally sold as inexpensive illuminators for microscopes. They are some of the cheapest and highest density bright LEDs we can find, and they work well for taking photos of our moths.
...
Basically, you want to remove all the plastic to turn your ring light from the product on the left, to the bare ring with two wires sticking out of it pictured on the right.
![image](https://github.com/user-attachments/assets/ee0d6f32-ad19-42a2-8edf-7fdcadf48b12)
...
Some ringlights will now have all the electronics free. Some may still have some internal screws left connecting the circuit boards to the plastic. Unscrew them and remove it.
...
## Snip Control Knob Electronics Off
From the current version onward, we no longer need to keep the voltage control knob. That's because we are using our own 12V regulator.
This makes wiring _much easier_.

![PXL_20240908_222638718 MP](https://github.com/user-attachments/assets/cbb43a04-4cf8-4dbf-91e8-d59c1e07980e)

You basically just want to end up with the ring of LEDs with a red and black wire sticking out of them.

{:.note}
> Older versions of the Mothbox kept the control knob on the ring lights. If you see images with those knobs still in tact, don't worry about it - those are just out of date images.
...
One ring light should be finished and attached like this!
...
# Trim Your Zip ties
Now is a good time to trim up the ends of the zip ties.
