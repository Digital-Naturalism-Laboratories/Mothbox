...
![image](https://github.com/Digital-Naturalism-Laboratories/Mothbox_Hardware/tree/main/MothboxDIY/Laser%20Cutting%20Layouts/v4)

# Acrylic
In the [Github, there are files for all the parts you need to cut.](https://github.com/Digital-Naturalism-Laboratories/Mothbox/tree/main/Hardware/Case/MothboxDIY/Laser%20Cutting%20Layouts/v4)
You can use the dxf files, or we even made layouts of many of the components in lightburn files for you. There is even a [file of "all acrylic parts"](https://github.com/Digital-Naturalism-Laboratories/Mothbox_Hardware/blob/main/MothboxDIY/Laser%20Cutting%20Layouts/v4/AllAcrylicPartsInOne.lbrn2) that you could cut in one go on many standard laser cutters.
