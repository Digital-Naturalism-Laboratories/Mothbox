---
layout: default
title: Case (Off-the-Shelf)
parent: External Parts
#has_children: true
nav_order: 1
---

If your 3D printing capactity is limited, you can modify an off-the-shelf case that will protect your electronics
This is the Plano 1460-00 box. Others have also modified waterproof junction boxes with clear lids in a similar way.

The Mothbox has 2 main *external parts* that connect to the case
* Lens Connector
* Arms
