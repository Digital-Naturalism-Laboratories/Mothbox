...
* [Guia de Campo en Español](https://drive.google.com/file/d/1-6dB0lFeB0YspATzdIpFmKTpyK269oSG/view?usp=sharing)
...
- [ ] Hang Mothbox. Using the handle, strap mothbox to a tree or tripod. Make sure there are no obstacles (like leaves or tall grasses) that may blow between the box and the target. In general, the Mothbox should be at least 0.5 meters above the ground.
