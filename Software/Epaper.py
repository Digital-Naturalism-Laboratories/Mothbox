...
"""
Epaper Display
This script will send text and images to an attached 2.13in epaper display

Generally it will just run whenever a mothbox starts up
...
try:
    ...
    draw.text((30, 40), "mothbox name: "+mbname, font = font15, fill = 255)
